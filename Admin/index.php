  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="?page=bell&aksi=tambah_peserta" onclick="return confirm('Anda yakin akan tambah peserta?')">
            <i class="fa fa-user-plus"></i> <span>Tambah Peserta</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
        <li>
          <a href="?page=bell&aksi=reset_peserta" onclick="return confirm('Anda yakin akan reset semua peserta?')">
            <i class="fa fa-user-times"></i> <span>Reset Peserta</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
      ...
      <div class="row">
        ...
        <?php
          ...
          if($page=='bell'){
            ...
            } else if ($aksi=='tambah_peserta') {
              include 'bell/tambah_peserta.php';
            } else if ($aksi=='reset_peserta') {
              include 'bell/reset_peserta.php';
            } else if ($aksi=='reset_bell') {
              include 'bell/reset_bell.php';
            } else if ($aksi=='tambahpoin_peserta') {
              include 'bell/tambah_poin.php';
            } else if ($aksi=='reset_poin') {
              include 'bell/reset_poin.php';
            }
          }
        ?>
      </div>
